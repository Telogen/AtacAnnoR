...
RunAtacAnnoR <- function(ref_mtx, ref_celltype, ref_type = "sc",
  ...
  cell_meta <- test_markers(query_mtx,cell_meta,global_markers,neighbor_markers,threads = threads,verbose = verbose)
...
#' @export
#'
RunAtacAnnoR_SnapATAC <- function(ref_mtx, ref_celltype,ref_type = "sc",
                                  query_snapObj,threads = 10, verbose = TRUE){
...
#' @export
#'
RunAtacAnnoR_ArchR <- function(ref_mtx, ref_celltype,ref_type = "sc",
                                 query_ArchRproj,threads = 10, verbose = TRUE){
...
#' @export
RunAtacAnnoR_Cicero <- function(ref_mtx, ref_celltype,ref_type = "sc",
                                query_cds,query_gene_activity,threads = 10, verbose = TRUE){
